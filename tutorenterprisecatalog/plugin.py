...
catalog_config = {
    ...
    "defaults": {
        ...
        "MYSQL_DATABASE": "enterprise-catalog",
        "MYSQL_USERNAME": "enterprise-catalog",
...
license_manager_config = {
    ...
    "defaults": {
        ...
        "PORT": 8170,
        "EXTRA_PIP_REQUIREMENTS": [],
        "MYSQL_DATABASE": "license-manager",
        "MYSQL_USERNAME": "license-manager",
...
access_config = {
    ...
    "defaults": {
        ...
        "PORT": 8270,
        "EXTRA_PIP_REQUIREMENTS": [],
        "MYSQL_DATABASE": "enterprise-access",
        "MYSQL_USERNAME": "enterprise-access",
...
subsidy_config = {
    ...
    "defaults": {
        ...
        "PORT": 8280,
        "EXTRA_PIP_REQUIREMENTS": [],
        "MYSQL_DATABASE": "enterprise-subsidy",
        "MYSQL_USERNAME": "enterprise-subsidy",
