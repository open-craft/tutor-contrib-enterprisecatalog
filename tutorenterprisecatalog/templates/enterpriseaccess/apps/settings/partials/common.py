SECRET_KEY = "{{ ENTERPRISE_ACCESS_SECRET_KEY }}"
ALLOWED_HOSTS = [
    "enterprise-access",
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://{% if REDIS_USERNAME and REDIS_PASSWORD %}{{ REDIS_USERNAME }}:{{ REDIS_PASSWORD }}{% endif %}@{{ REDIS_HOST }}:{{ REDIS_PORT }}/{{ ENTERPRISE_ACCESS_CACHE_REDIS_DB }}",
    }
}
...
{{ patch("enterprise-access-common-settings") }}
